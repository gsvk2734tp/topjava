...
public abstract class JdbcMealRepositoryImpl<T> implements MealRepository {
    ...
    abstract T ConverterTime(LocalDateTime localDateTime);
    ...
    public static class PostgresJdbcMealRepositoryImpl extends JdbcMealRepositoryImpl<LocalDateTime> {
        ...
        @Override
        LocalDateTime ConverterTime(LocalDateTime localDateTime) {
    ...
    public static class HSQLJdbcMealRepositoryImpl extends JdbcMealRepositoryImpl<Timestamp> {
        ...
        @Override
        Timestamp ConverterTime(LocalDateTime localDateTime) {
    ...
    public Meal save(Meal meal, int userId) {
        MapSqlParameterSource map = new MapSqlParameterSource()
                ...
                .addValue("date_time", ConverterTime(meal.getDateTime()))
    ...
    public List<Meal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int userId) {
        return jdbcTemplate.query(
                ...
                ROW_MAPPER, userId, ConverterTime(startDate), ConverterTime(endDate));
    }
}
